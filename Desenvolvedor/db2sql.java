...
public class db2sql {
    ...
    public static String dumpDB(Properties props) {
        String driverClassName = props.getProperty("org.apache.derby.jdbc.ClientDriver");
        String driverURL = props.getProperty("jdbc:derby://localhost:1527/AABD");
        ...
        try {
            ...
            dbConn = DriverManager.getConnection(driverURL,user,passwd);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Unable to open property file: "+s+" exception: "+e);
        }
